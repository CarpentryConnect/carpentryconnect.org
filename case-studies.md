...
![Process](img/in-person/our_process.png)
...
This section lists major updates only. For a complete history, see the [document history](https://github.com/imarc/handbook/commits/gh-pages/in-person.markdown) on GitHub.
